...
# -*- coding: utf-8 -*-
"""
Created on Sun Nov  8 11:31:56 2020
...
# -*- coding: utf-8 -*-
"""
Created on Sat Nov  7 18:51:27 2020
...
def basinIndex(wd, path_input, path_output, dem, basin, crs):
    ...
    # Output path
#    outpath = os.path.join(os.getcwd(), 'output2')
    outpath = path_output
    ...
    for i in range(len(basin_prj)):
        ...
        # Index: Average Mainchannel Slope
...
#        ls_slope_ratio.extend([slope_ratio])
        ...
        print("The perimeter of the basin is",basin_perimeter, "km; \n",
              "The area of the basin is", basin_area, "km2; \n",
              "Circularity Ratio is", circularity_ratio, "\n",
              "The east and north coordinateof outlet is", east_o, ",", north_o, "\n",
              "The Main Channel Length is", MCL, "km; \n",
              "The elongation ratio is ", elon_ratio, "\n",
              "The Form Factor is ", form_factor, "\n",
              "The max Altitude is ", height_max, "m; \n", 
              "The min Altitude is ", height_min, "m; \n",
              "The relative Relief is ", relative_relief, "m. \n",
              "Mean Elevation is ", mean_elev, "m \n",
              "The Relief Ratio is ", relief_ratio, "\n",
              "The Dissection Index is ", dissection_index, "\n",
              "Hypsometric Integral is ", hypsom, "\n",
              "Average Basin Slope is ", basin_slope, "\n",
#              "Mean slope of mainchannel is", mainchannel_slope, "%, \n",
              "Total stream length is ", Len_streams, "km \n",
              "Bifurcation Ratio is ", Bif_ratio, "\n",
              "Channel Gradient is", channel_gradient, "\n")
#              "Slope Ratio is ", slope_ratio)
...
#                                     slope_ratio = ls_slope_ratio
    ...
    return(print("The calculated Parameters are stored as attributes of ", path_basin_index))
    
    


wd = '/home/shirobakaidou/docker_lab/morph_index/morph_index_docker/test'
path_input = '/home/shirobakaidou/docker_lab/morph_index/morph_index_docker/test/input'
path_output = '/home/shirobakaidou/docker_lab/morph_index/morph_index_docker/test/output'
