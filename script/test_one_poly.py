...
def basinIndex(wd, path_input, dem, basin, crs):
    ...
    # GRASS Database
    grass_dbase = os.path.join(os.getcwd(), 'grass2')
    ...
    print("The perimeter of the basin is",basin_perimeter, "km; \n",
          ...
          "The max Altitude is ", height_min, "m; \n", 
...
basinIndex(wd=wd, path_input=path_input, dem=dem_input, basin=basin_input, crs=dst_crs)